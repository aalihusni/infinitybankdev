...
<meta property="og:url"           content="{{ env('SITE_URL') }}/explainer-video" />
<meta property="og:type"          content="website" />
<meta property="og:title"         content="How does Bitregion work? Watch this!" />
...
<meta property="og:image"         content="{{asset('web_content/img/promo01.jpg')}}" />

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@bitregion">
<meta name="twitter:creator" content="@bitregion">
<meta name="twitter:title" content="How does Bitregion work? Watch this!">
...
<meta name="twitter:image" content="{{asset('web_content/img/promo01.jpg')}}">
...
<div role="main" class="main">
    <div class="container">
        <div class="col-lg-8 landing_container">
            <p class="lp_main_headline">{{trans('landing.headline_1')}}</p>
            <p class="lp_sub_headline">{{trans('landing.sub_headline_1')}}</p>
            <video controls="controls" width="100%" autoplay>
                <source src="{{asset('download/donation_hybrid'.trans('landing.video_file').'.mp4')}}" type="video/mp4">
            ...
            <div class="optin-container-mid">
                <div class="col-lg-12 optin-container-mid">
                            ...
                            <div class="form-horizontal form-bordered">
                                ...
                                @else
                                <div class="optin-subtitle">{{trans('landing.form_headline')}}:<br><br>
                                    ...
                                    @else
                                    <span class="optin-subtitle-lg">{{trans('landing.form_sub_headline')}}</span>
                                    @endif
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="text" name="firstname" id="firstname" class="form-control" placeholder="{{trans('landing._firstname')}}" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="text" name="lastname" id="lastname" class="form-control" placeholder="{{trans('landing._lastname')}}" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="text" name="email" id="email" class="form-control" placeholder="{{trans('landing._email')}}" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input type="text" name="mobile" id="mobile" class="form-control" placeholder="{{trans('landing._mobile')}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 form-control-static">
                                        {{trans('landing._aggree')}}
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-block btn-lg">{{trans('landing._yes_contact_me')}}</button>
                                    </div>
                                </div>
                                </form>
                                @endif
                                <br>
                                    <table width="100%">
                                        <tr>
                                            <td align="right">{{trans('landing._follow')}}: </td>
                                            <td align="left">&nbsp;&nbsp;
