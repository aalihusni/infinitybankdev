...
@section('extrameta')
<meta property="og:url"           content="{{ env('SITE_URL') }}/crowdfunding" />
<meta property="og:type"          content="website" />
<meta property="og:title"         content="Bitregion Crowdfunding Explained" />
...
<meta property="og:image"         content="{{asset('web_content/img/promo03.jpg')}}" />

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@bitregion">
<meta name="twitter:creator" content="@bitregion">
<meta name="twitter:title" content="Bitregion Crowdfunding Explained">
...
<meta name="twitter:image" content="{{asset('web_content/img/promo03.jpg')}}">
@Stop
...
<div role="main" class="main">
    <div class="container">
        <div class="col-lg-8 landing_container">
            <p class="lp_main_headline">Bitregion Crowdfunding Explained</p>
            <p class="lp_sub_headline">Let us explain how you can earn unlimited Bitcoin income by just contributing 0.15BTC!</p>
            <video width="100%" autoplay>
                <source src="{{asset('download/crowdfunding.mp4')}}" type="video/mp4">
