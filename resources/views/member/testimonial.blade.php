                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            {!! Form::open(array('url'=>'members/upload-video','method'=>'POST', 'files'=>true, 'class'=>'form-horizontal form-bordered')) !!}

                            <div class="form-group">
                                <label class="col-md-5 control-label" for="inputDefault"><img src="{{asset('img/testi.png')}}"></label>
                                <div class="col-md-4">
                                    <label class="control-label"><strong>Your Testimonial Video</strong></label><br><br>
                                    We are gathering all the success stories here! Let's contribute all marketing meterials to grow this community together.<br><br>
                                    {!! Form::file('image', '', array('class'=>'form-control','placeholder'=>trans('front.choose_image'))) !!}<br>
                                    @if(Auth::user()->profile_pic)
                                        {!! Form::submit("Upload Video", array('class'=>'btn btn-primary btn-block')) !!}
                                    @else
                                        {!! Form::submit("Upload Video", array('class'=>'btn btn-primary btn-block')) !!}
                                    @endif
                                </div>
