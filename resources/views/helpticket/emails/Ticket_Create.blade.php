---Please do not reply through this email---<br/><br/>
...
You can check the status of or update this ticket online at: <a href="{!! \URL::route('my-tickets') !!}">{!! \URL::route('my-tickets') !!}</a><br/><br/>
