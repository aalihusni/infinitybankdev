            ...
            <div class="col-lg-12">
    				<section class="panel">
							<header class="panel-heading">
								...
								<span class="pull-right"><a href="{{url('Admin/Manage/Category/create')}}" class="btn btn-primary btn-xs">Add Category</a></span>
								</h2>
							</header>
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									@foreach($categories as $cat)
										<tr class="gradeX" id="row-{{$cat->id}}">
											...
											<a href="{{url('Admin/Manage/Category/'.$cat->id.'/edit')}}" class="btn btn-warning btn-xs"><i aria-hidden="true" class="fa fa-pencil"></i></a>&nbsp;
											<a href="{{url('category-list/'.$cat->slug)}}" class="btn btn-primary btn-xs hide"><i aria-hidden="true" class="fa fa-eye"></i></a>
