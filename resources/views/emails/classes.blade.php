            ...
            <td>
                <div style="padding:30px; background-color:#FFF; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; font-size:14px; font-family: sans-serif; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; color:#999;">
                    ...
                    <p>Your first Assistance contribution is successful.<br>
                        ...
                        <strong>Your new class:</strong> {{$newclass}} <br><br>
                    </p>
                    <p>
                    ...
                    <ul>
                        <li>To receive more Assistance, please introduce/sponsor as many new members as possible. Please guide each downline to introduce/sponsor at least 3 new members.. </li>
                        <li>To receiving more daily dividend, please pledge PH in Region Bank.</li>
                    </ul><br>
                    </p>
                    <p>Thank you.</p>
