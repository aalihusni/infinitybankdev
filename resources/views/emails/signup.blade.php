        ...
        <tr>
            ...
            <td>
                <div style="padding:30px; background-color:#FFF; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; font-size:14px; font-family: sans-serif; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; color:#999;">
                    <p>Dear new member,</p>
                    <p>You have to verify the email address <strong style="color:#000;">{{ $email }}</strong> registered to your account.</p>
                    <p>To verify and complete your registration, please click the button below:<br/><br/>

                        <!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://verifyemail.com/" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="#e2a029">
                            <w:anchorlock/>
                            <center>
                        <![endif]-->
                        <a href="{{ env('SITE_URL') }}/verify/{{ $verificationcode }}"
                           style="background-color:#e2a029;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Verify Your Email</a>
                        <!--[if mso]>
                        </center>
                        </v:roundrect>
                        <![endif]-->
                    ...
                    <p>You will be automatically login to your account after clicking above button.</p>
                    <p>Thank you.</p>
