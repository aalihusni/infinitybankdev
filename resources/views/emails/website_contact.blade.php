        ...
        <tr>
            ...
            <td>
                <div style="padding:30px; background-color:#FFF; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; font-size:14px; font-family: sans-serif; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; color:#999;">
                    ...
                    <p>You got a message from our official website.<br><br>
                    </p>
                    <p>
                        Here is the information about the sender & the message.
                        <table>
                        <tr>
                    ...
                    <br><br>
                    <div style="font-size:12px; color:#999; border-top:thin solid #CCC; padding-top:10px;">You receive this because someone submitted a contact form from a website with your referral link.<br>
