...
<head>
    ...
    <title>Your PH that was matched is now expired</title>
</head>
        ...
        <tr>
            ...
            <td>
                <div style="padding:30px; background-color:#FFF; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; font-size:14px; font-family: sans-serif; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; color:#999;">
                    ...
                    <p>Your PH that was matched is now expired! (ID: #{{ $phghid }})<br><br>
                    </p>
                    <p>
                       We are sorry to inform that you have missed the chance to earn higher dividend! Your PH that was matched is now expired and is now in queue. Please wait for our next notification if your PH is matched again.
