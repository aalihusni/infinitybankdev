...
<head>
    ...
    <title>Congratulations! Your Pledged PH is now matched</title>
</head>
        ...
        <tr>
            ...
            <td>
                <div style="padding:30px; background-color:#FFF; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; font-size:14px; font-family: sans-serif; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; color:#999;">
                    ...
                    <p>Congratulations! Your Pledged PH is now matched. (ID: #{{ $phghid }})<br><br>
                    </p>
                    <p>
                       You have {{ isset($day_assigned_expiry) ? $day_assigned_expiry : "1" }} days [Last day to transfer {{ $expiry->toDateTimeString() }}] to transfer your bitcoin to the receiver and you will start earning 1% daily dividend once you have make all payment for this particular Pledged PH order.
