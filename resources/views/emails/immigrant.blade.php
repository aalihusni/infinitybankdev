        ...
        <tr>
            ...
            <td>
                <div style="padding:30px; background-color:#FFF; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; font-size:14px; font-family: sans-serif; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: none; color:#999;">
                    <br><p>Dear <strong>{{$username}}</strong>,<br><br></p>
                    <p>CONGRATULATIONS!</p>
                    <p>Welcome, you are oficially a Bitregion community member!</p><br>
                    <p>Your first Assistance contribution is successful.<br>
                        <strong>Amount:</strong> 0.15000000 BTC<br>
                        <strong>Your new class:</strong> Immigrant <br><br>
                    </p>
                    <p>
                        You are now entitled to start accumulating unlimited Bitcoin through Bitregion.
                        <table>
                        <tr>
                            <td><strong>Receive Assistance</strong></td>
                            <td>: 0.45BTC</td>
                        </tr>
                        <tr>
                            <td><strong>Receive Give Back</strong></td>
                            <td>: (subject to your direct UP generation)</td>
                        </tr>
                        <tr>
                            <td><strong>Receive Dividend (Region Bank)</strong></td>
                            <td>: Pledged PH 0.5% daily, or Active PH 1.0% daily</td>
                        </tr>
                        <tr>
                            <td><strong>Passport Referral Bonus</strong></td>
                            <td>: 10% of direct referrals (1st tier)</td>
                        </tr>
                        <tr>
                            <td><strong>Passport Overriding Bonus</strong></td>
                            <td>: none <em>(only for Visa Holder onwards)</em></td>
                        </tr>
                        <tr>
                            <td><strong>PH Referral Bonus</strong></td>
                            <td>: 10% of direct referrals (1st tier)</td>
                        </tr>
                        <tr>
                            <td><strong>PH Overriding Bonus</strong></td>
                            <td>: none <em>(only for Citizen onwards)</em></td>
                        </tr>
                        <tr>
                            <td><strong>Flex Pairing Bonus</strong></td>
                            <td>: none <em>(only for Permanent Resident onwards)</em></td>
                        </tr>
                    </table>
                    </p><br>
                    ...
                    <ul>
                        <li>To start receiving Assistance, please introduce/sponsor new members into Bitregion as many as possible <strong>(at least 3 contributors)</strong>. </li>
                        <li>To start receiving daily dividend, please pledge PH in Region Bank.</li>
                    </ul><br>
                    </p>
                    <p>Thank you.</p>
